...
function websdkready() {
  ...
  var CLIENT_ID = "ZVpS7RaJQuaoUoisy_dWQQ";
  /**
   ...
   */
  var CLIENT_SECRET = "XFj2k517J8SrI3YGJ0c0AJk8ZnewwA4o";
...
/*
      var signature = ZoomMtg.generateSDKSignature({
        ...
        success: function (res) {
          ...
          var joinUrl = "http://localhost/zoom/CDN/meeting.html?" + testTool.serialize(meetingConfig);
          console.log(joinUrl);
    ...
    var signature = ZoomMtg.generateSDKSignature({
      ...
      success: function (res) {
        ...
        var joinUrl =
          ...
          "http://localhost/zoom/CDN/meeting.html?" +
