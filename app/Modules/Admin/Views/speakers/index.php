  ...
  <?php foreach ($speakers as $sp): ?>
    <div class="bg-gray-800 border border-gray-700 rounded-lg shadow hover:shadow-lg transition">
      <?php if ($sp['speaker_photo']): ?>
        <img src="<?php echo base_url($sp['speaker_photo']); ?>" class="w-full h-48 object-cover rounded-t-lg">
      <?php endif; ?>
      <div class="p-5">
        ...
        <div class="mt-4 flex justify-end gap-2">
          <a href="<?php echo site_url('admin/speakers/' . $sp['id'] . '/edit'); ?>"
             class="px-3 py-1 bg-blue-600 hover:bg-blue-700 text-white text-xs rounded">Edit</a>
          <a href="<?php echo site_url('admin/speakers/' . $sp['id'] . '/delete'); ?>"
